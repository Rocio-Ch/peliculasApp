          ...
          <SwiperSlide key={movie.id} className="bg-center bg-cover">
            <div className="relative w-full text-white flex justify-center">
              <img
                ...
                className="w-full max-h-[900px] block"
              />
            </div>
            <div className="absolute flex flex-col items-center justify-center text-white w-[90%] bottom-[30px] p-2.5 bg-[#262729ed] rounded lg:p-5 lg:text-[2rem] xl:w-2/5 xl:bottom-10">
              <h2 className="text-center text-sm font-semibold mb-2 md:text-xl xl:mb-4 xl:text-[2rem]">
                {movie.title}
              </h2>
              <Link to={`/description/${movie.id}`}>
                <button className="text-xs py-1 px-4 bg-[#007aff] rounded lg:py-1 lg:px-6 lg:bottom-[120px] lg:text-lg">
                  More
                </button>
              </Link>
            </div>
