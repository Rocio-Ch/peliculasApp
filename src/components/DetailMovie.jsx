    ...
    return (
        <section>
            {loading ? (
                ...
                style={{backgroundImage: `url(${data.backdrop_path ? `https://image.tmdb.org/t/p/original/${data.backdrop_path}` : defaultBackdrop})`}}
                    ></div>
                    <div className="w-[90%] left-[5%] top-[-4%] absolute flex flex-col items-center justify-center text-white min-[600px]:top-[0%] lg:flex-row lg:w-full lg:top-[15%] lg:left-[0%] lg:top-[15%]">
                        <div className="flex justify-center w-full h-[100%] md:w-[70%] lg:max-w-[500px] lg:mr-2.5 lg:px-5">
                            <div className="h-[350px] w-[300px] mt-[102px] bg-no-repeat bg-center bg-cover lg:h-[600px] lg:w-[460px] lg:mt-0 shadow-[0px_0px_30px_1px_rgba(64,64,69,43%)]" style={{backgroundImage: `url(${data.poster_path ? `https://image.tmdb.org/t/p/original/${data.poster_path}` : defaultPoster})`}} />
                        </div>
                        <div className="w-full md:w-[70%] lg:max-w-[700px] lg:h-[600px] lg:flex lg:flex-col lg:justify-between">
                            <div className="bg-[#030317b0] p-2.5 my-2.5 rounded-lg lg:mt-0 lg:p-[20px] lg:mr-5">
                                <div className="flex flex-wrap items-center justify-between mt-2 mb-4 px-1">
                                    <h3 className="font-bold mb-2.5 lg:text-2xl">{data.title} - <span className="font-normal">{data.release_date?.split("-")[0]}</span></h3>
                                ...
                                <div className="flex items-center">
                                    <a href={`https://www.imdb.com/title/${data.imdb_id}`} target="_blank" className="flex flex-col justify-center group relative h-8 w-20 overflow-hidden rounded-lg bg-white text-lg shadow">
